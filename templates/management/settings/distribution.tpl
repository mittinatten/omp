...
<div id="distributionTabs" class="pkp_controllers_tab">
	<ul>
		...
		<li><a name="embargo" href="{url router=$smarty.const.ROUTE_COMPONENT component="tab.settings.DistributionSettingsTabHandler" op="showTab" tab="embargo"}">{translate key="submission.embargo"}</a></li>
	</ul>
</div>
