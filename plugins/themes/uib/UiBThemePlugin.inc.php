...
/**
 * @file plugins/themes/uib/UiBThemePlugin.inc.php
 *
 * Copyright (c) 2014-2016 Simon Fraser University Library
 * Copyright (c) 2003-2016 John Willinsky
 * Distributed under the GNU GPL v2. For full terms see the file docs/COPYING.
 *
 * @class UiBThemePlugin
 * @ingroup plugins_themes_uib
 *
 * @brief UiB theme
 */
...
class UiBThemePlugin extends ThemePlugin {
	/**
	 * Constructor
	 */
	function UiBThemePlugin() {
		parent::ThemePlugin();
	...
	function getDisplayName() {
		return __('plugins.themes.uib.name');
	}
	...
	function getDescription() {
		return __('plugins.themes.uib.description');
	}
